...
export default function StudentProfile() {
  ...
  const skills: { name: string; level: "Beginner" | "Intermediate" | "Advanced"; color: string }[] = [
    { name: "JavaScript", level: "Advanced", color: "#3B82F6" },
    { name: "TypeScript", level: "Intermediate", color: "#F59E0B" },
    { name: "React.JS", level: "Beginner", color: "#EC4899" },
    { name: "Node.JS", level: "Intermediate", color: "#F0F0F0" },
    { name: "UI/UX Design", level: "Intermediate", color: "#10B981" },
    { name: "Data Structures", level: "Advanced", color: "#8B5CF6" },
  ]
